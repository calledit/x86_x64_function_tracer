...
void render(ID3D11DeviceContext* d3d11DeviceContext, float windowWidth, float windowHeight,
    float4x4 modelViewProj,
    ID3D11RasterizerState* rasterizerState,
    ID3D11DepthStencilState* depthStencilState,
    ID3D11RenderTargetView* d3d11FrameBufferView, ID3D11DepthStencilView* depthBufferView,
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    while(isRunning)
    {
        ...
        render(d3d11DeviceContext, (float)windowWidth, (float)windowHeight,
            modelViewProj,
            rasterizerState,
            depthStencilState,
